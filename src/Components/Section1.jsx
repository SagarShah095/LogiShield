    ...
    <div className="">
      <div className="grid grid-cols-4 gap-4">
        <div className="space-y-2 bg-white w-full p-4 rounded-xl mt-4">
          ...
          <h1 className="text-3xl font-bold">₹ 3,248</h1>
        </div>
        <div className="space-y-2 bg-white w-full p-4 rounded-xl mt-4">
          ...
          <h1 className="text-3xl font-bold">89.4%</h1>
        </div>
        <div className="space-y-2 bg-white w-full p-4 rounded-xl mt-4">
          ...
          <div className="flex items-end h-full pb-10">
            <h1 className="text-3xl flex items-end h-full font-bold">
              423 / 500
            </h1>
          </div>
        </div>
        <div className="space-y-2 bg-white w-full p-4 rounded-xl mt-4">
          ...
          <h1 className="text-3xl font-bold">1.2Hr</h1>
        </div>
      </div>
    </div>
  );
